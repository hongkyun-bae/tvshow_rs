...
def parse_args():
    ...
    parser.add_argument('--mode', type=int,default=-1, help='0 - Build Matrix, 1 - Evaluation')
...
if __name__ == '__main__':
    ...
    if mode == 0:
        ...
        wl_2m_df, wl_1m_df, epg2_df, epg1_df, programs2, users2, programs1, users1 = ReadData.Preprocessing(CV, wl_6m_df, epg_df, mode, PrefMatrix)
        ...
        if wALS == 1 or method == 'PNM' or method in ['Prop', 'Prop_New']:
            ...
            Score, ndcgs, MRR = ShowTime.Experiment_ST(epg_df, wl_2m_df, Checked_TestSet, PrefMatrix, predMatrix, time_factor_histogram, log, 'log.txt', data_type=1)
            if D != 1:
                # For non-watched test set (pred)
                Score2, ndcgs2, MRR2 = ShowTime.Experiment_ST(epg_df, wl_2m_df, Unchecked_TestSet, PrefMatrix, predMatrix, time_factor_histogram, log, 'log.txt', data_type=0)
        ...
        print ("Mode should be from 0 to 1.")
    #'''
